...
#define AUTH "MTQz63A3bYePryv_O-bH67LIr8McJSVD"                 // You should get Auth Token in the Blynk App.  
...
void with_internet(){
    ...
    else if (digitalRead(SwitchPin7) == HIGH){
      delay(1000);
      relayOnOff(7);
      Blynk.virtualWrite(VPIN_BUTTON_7, toggleState_7);   // Update Button Widget
    }
    else if (digitalRead(SwitchPin8) == HIGH){
      delay(1000);
      relayOnOff(8);
