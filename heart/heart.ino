...
String apiKey = "NBJ84OZB7O4M7HN0";  
const char* serve = "api.thingspeak.com";
char auth[] = "Sx8Z4Prh_jz0JXAwhPaJJk_n57eMLAvv";
...
oled.clearDisplay();
        ...
        oled.setCursor(0,45);
        oled.print("Temp");
        oled.print(bodytemperature);
        oled.println("C");
        oled.display();

 
if (client.connect(serve,80))   //   "184.106.153.149" or api.thingspeak.com
                      {  
                             ...
                             postStr += String(SpO2);
                             postStr +="&field3=";
                             postStr += String(bodytemperature);
                             postStr +="&field4=";
